...
- Run the project's `verify-deploy.sh` script (if one exists) after the deployment completes
- Report pass/fail results before telling the user the change is live
- Never say "it should work" without fetching and checking the deployed output
