...
title: Humanizer - Remove AI Writing Tells
scope: global
category: engagement
icon: &#9999;&#65039;
triggers:
...
checks:
  - Strip significance inflation, promo language, and -ing filler
  - Cut em dashes, rule-of-three, boldface, and curly quotes
  - Add a real voice - opinions, varied rhythm, first person
  - Final pass - ask what still reads as AI, then revise
licence: MIT
